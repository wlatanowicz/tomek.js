...
klass( 'TTestControl012', TTemplateControl, {
	
	
} );


TTestControl012.prototype.createChildControls = function(){
	var ExpressionContext = this;
	var SourceTemplateControl = this;
	var c110 = new TContent( [] );
	this.addTemplateChildControl( "c110", c110 );
	c110.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c111"].renderContentsInPlaceholder( placeholder );
	};
	var c111 = new TContent( [] );
	c110.addTemplateChildControl( "c111", c111 );
	c111.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c112"].renderContentsInPlaceholder( placeholder );
		this._templateControls["c113"].renderContentsInPlaceholder( placeholder );
		this._templateControls["c114"].renderContentsInPlaceholder( placeholder );
	};
	var c112 = new TLiteral(  {
					"Text" : "L1",
					"Visible" : ( new TExpression( function(){ return ( true || false ); }.bind( ExpressionContext ) ) )
					}  );
	c111.addTemplateChildControl( "c112", c112 );
	var c113 = new TLiteral(  {
					"Text" : "L2",
					"Visible" : ( new TExpression( function(){ return ( true && false ); }.bind( ExpressionContext ) ) )
					}  );
	c111.addTemplateChildControl( "c113", c113 );
	var c114 = new TLiteral(  {
					"Text" : "L3",
					"Visible" : ( new TExpression( function(){ return ( true && true ); }.bind( ExpressionContext ) ) )
					}  );
	c111.addTemplateChildControl( "c114", c114 );
};
