...
klass( 'TTestControl009', TTemplateControl, {	
	
} );


TTestControl009.prototype.createChildControls = function(){
	var ExpressionContext = this;
	var SourceTemplateControl = this;
	var c92 = new TContent( [] );
	this.addTemplateChildControl( "c92", c92 );
	c92.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c93"].renderContentsInPlaceholder( placeholder );
	};
	var c93 = new TContent( [] );
	c92.addTemplateChildControl( "c93", c93 );
	c93.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c94"].renderContentsInPlaceholder( placeholder );
	};
	var c94 = new TPanel(  {
					"ID" : "WC"
					}  );
	c93.addTemplateChildControl( "c94", c94 );
	c94.renderTemplateChildControls = function( placeholder ){
		var t_c95 = document.createTextNode( "\n\t\ttest\n\t" );
		placeholder.appendChild( t_c95 );
	};
};
