...
TTestControl000.prototype.createChildControls = function(){
	var ExpressionContext = this;
	var SourceTemplateControl = this;
	var c1 = new TContent( [] );
	this.addTemplateChildControl( "c1", c1 );
	c1.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c2"].renderContentsInPlaceholder( placeholder );
	};
	var c2 = new TContent( [] );
	c1.addTemplateChildControl( "c2", c2 );
};
