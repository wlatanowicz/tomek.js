...
TTestControl005.prototype.createChildControls = function(){
	var ExpressionContext = this;
	var SourceTemplateControl = this;
	var c52 = new TContent( [] );
	this.addTemplateChildControl( "c52", c52 );
	c52.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c53"].renderContentsInPlaceholder( placeholder );
	};
	var c53 = new TContent( [] );
	c52.addTemplateChildControl( "c53", c53 );
	c53.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c54"].renderContentsInPlaceholder( placeholder );
		this._templateControls["c55"].renderContentsInPlaceholder( placeholder );
	};
	var c54 = new TButton(  {
					"ID" : "Button",
					"Attributes.id" : "button"
					}  );
	c53.addTemplateChildControl( "c54", c54 );
	c54.attachEvent( "Click", SourceTemplateControl.buttonClicked.bind( SourceTemplateControl ) );
	var c55 = new TButton(  {
					"ID" : "Button2",
					"Attributes.id" : "button2"
					}  );
	c53.addTemplateChildControl( "c55", c55 );
	c55.attachEvent( "Click", SourceTemplateControl.buttonClicked.bind( SourceTemplateControl ) );
};
