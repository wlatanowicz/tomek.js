...
klass( 'TTestControl004', TTemplateControl, {	
	
} );


TTestControl004.prototype.createChildControls = function(){
	var ExpressionContext = this;
	var SourceTemplateControl = this;
	var c29 = new TContent( [] );
	this.addTemplateChildControl( "c29", c29 );
	c29.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c30"].renderContentsInPlaceholder( placeholder );
	};
	var c30 = new TContent( [] );
	c29.addTemplateChildControl( "c30", c30 );
	c30.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c31"].renderContentsInPlaceholder( placeholder );
	};
	var c31 = new TRepeater(  {
					"ID" : "Rep",
					"ShowFooterWhenEmpty" : "false",
					"ShowHeaderWhenEmpty" : "false"
					}  );
	c30.addTemplateChildControl( "c31", c31 );
	c31.setHeaderTemplate( function( item ){
		var ExpressionContext = item;
		var c33 = new TContent( [] );
		item.addTemplateChildControl( "c33", c33 );
		c33.renderTemplateChildControls = function( placeholder ){
			this._templateControls["c34"].renderContentsInPlaceholder( placeholder );
		};
		var c34 = new TControl( [] );
		c33.addTemplateChildControl( "c34", c34 );
		c34.renderTemplateChildControls = function( placeholder ){
			var h_c35 = document.createElement( "span" );
			h_c35.setAttribute( "class", "header" );
			var t_c36 = document.createTextNode( "\n\t\t\t\t\tHeader\n\t\t\t\t" );
			h_c35.appendChild( t_c36 );
			placeholder.appendChild( h_c35 );
		};
	} );
	c31.setFooterTemplate( function( item ){
		var ExpressionContext = item;
		var c38 = new TContent( [] );
		item.addTemplateChildControl( "c38", c38 );
		c38.renderTemplateChildControls = function( placeholder ){
			this._templateControls["c39"].renderContentsInPlaceholder( placeholder );
		};
		var c39 = new TControl( [] );
		c38.addTemplateChildControl( "c39", c39 );
		c39.renderTemplateChildControls = function( placeholder ){
			var h_c40 = document.createElement( "span" );
			h_c40.setAttribute( "class", "footer" );
			var t_c41 = document.createTextNode( "\n\t\t\t\t\tFooter\n\t\t\t\t" );
			h_c40.appendChild( t_c41 );
			placeholder.appendChild( h_c40 );
		};
	} );
	c31.setEmptyTemplate( function( item ){
		var ExpressionContext = item;
		var c43 = new TContent( [] );
		item.addTemplateChildControl( "c43", c43 );
		c43.renderTemplateChildControls = function( placeholder ){
			this._templateControls["c44"].renderContentsInPlaceholder( placeholder );
		};
		var c44 = new TControl( [] );
		c43.addTemplateChildControl( "c44", c44 );
		c44.renderTemplateChildControls = function( placeholder ){
			var h_c45 = document.createElement( "span" );
			h_c45.setAttribute( "class", "empty" );
			var t_c46 = document.createTextNode( "\n\t\t\t\t\tEmpty\n\t\t\t\t" );
			h_c45.appendChild( t_c46 );
			placeholder.appendChild( h_c45 );
		};
	} );
	c31.setItemTemplate( function( item ){
		var ExpressionContext = item;
		var c48 = new TContent( [] );
		item.addTemplateChildControl( "c48", c48 );
		c48.renderTemplateChildControls = function( placeholder ){
			this._templateControls["c49"].renderContentsInPlaceholder( placeholder );
		};
		var c49 = new TControl( [] );
		c48.addTemplateChildControl( "c49", c49 );
		c49.renderTemplateChildControls = function( placeholder ){
			var h_c50 = document.createElement( "span" );
			h_c50.setAttribute( "class", "item" );
			h_c50.setAttribute( "id", "item_"+( new TExpression( function(){ return ( this.getItemIndex() ); }.bind( ExpressionContext ) ) ) );
			var t_c51 = document.createTextNode( "\n\t\t\t\t\tItem-"+( new TExpression( function(){ return ( this.getDataItem() ); }.bind( ExpressionContext ) ) )+"\n\t\t\t\t" );
			h_c50.appendChild( t_c51 );
			placeholder.appendChild( h_c50 );
		};
	} );
};
