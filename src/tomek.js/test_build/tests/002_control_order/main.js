...
TTestControl002.prototype.createChildControls = function(){
	var ExpressionContext = this;
	var SourceTemplateControl = this;
	var c9 = new TContent( [] );
	this.addTemplateChildControl( "c9", c9 );
	c9.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c10"].renderContentsInPlaceholder( placeholder );
	};
	var c10 = new TContent( [] );
	c9.addTemplateChildControl( "c10", c10 );
	c10.renderTemplateChildControls = function( placeholder ){
		var t_c11 = document.createTextNode( "\n\t\n\t001\n\t\n\t" );
		placeholder.appendChild( t_c11 );
		var h_c12 = document.createElement( "div" );
		var t_c13 = document.createTextNode( "\n\t\t002\n\t\t" );
		h_c12.appendChild( t_c13 );
		this._templateControls["c14"].renderContentsInPlaceholder( h_c12 );
		var t_c15 = document.createTextNode( "\n\t\t006\n\t" );
		h_c12.appendChild( t_c15 );
		placeholder.appendChild( h_c12 );
		this._templateControls["c16"].renderContentsInPlaceholder( placeholder );
	};
	var c14 = new TPanel( [] );
	c10.addTemplateChildControl( "c14", c14 );
	c14.renderTemplateChildControls = function( placeholder ){
		var t_c17 = document.createTextNode( "\n\t\t\t003\n\t\t\t" );
		placeholder.appendChild( t_c17 );
		var h_c18 = document.createElement( "div" );
		var t_c19 = document.createTextNode( "\n\t\t\t\t004\n\t\t\t" );
		h_c18.appendChild( t_c19 );
		placeholder.appendChild( h_c18 );
		var t_c20 = document.createTextNode( "\n\t\t\t005\n\t\t" );
		placeholder.appendChild( t_c20 );
	};
	var c16 = new TLiteral(  {
					"Text" : "007"
					}  );
	c10.addTemplateChildControl( "c16", c16 );
};


var c = new TTestControl002( { 'Placeholder' : 'container' } );
