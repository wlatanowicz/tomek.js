...
TTestControl001.prototype.createChildControls = function(){
	var ExpressionContext = this;
	var SourceTemplateControl = this;
	var c3 = new TContent( [] );
	this.addTemplateChildControl( "c3", c3 );
	c3.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c4"].renderContentsInPlaceholder( placeholder );
	};
	var c4 = new TContent( [] );
	c3.addTemplateChildControl( "c4", c4 );
	c4.renderTemplateChildControls = function( placeholder ){
		var h_c5 = document.createElement( "span" );
		h_c5.setAttribute( "id", "s1" );
		var t_c6 = document.createTextNode( "\n\t\t"+( new TExpression( function(){ return ( this.getTestText() ); }.bind( ExpressionContext ) ) )+"\n\t" );
		h_c5.appendChild( t_c6 );
		placeholder.appendChild( h_c5 );
		var h_c7 = document.createElement( "span" );
		h_c7.setAttribute( "id", "s2" );
		var t_c8 = document.createTextNode( "\n\t\tStatic text\n\t" );
		h_c7.appendChild( t_c8 );
		placeholder.appendChild( h_c7 );
	};
};
