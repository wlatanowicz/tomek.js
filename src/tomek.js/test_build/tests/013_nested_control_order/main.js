...
klass( 'TTestControl013b', TTemplateControl, {
	
	
} );


TTestControl013b.prototype.createChildControls = function(){
	var ExpressionContext = this;
	var SourceTemplateControl = this;
	var c125 = new TContent( [] );
	this.addTemplateChildControl( "c125", c125 );
	c125.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c126"].renderContentsInPlaceholder( placeholder );
	};
	var c126 = new TContent(  {
					"ID" : "cb"
					}  );
	c125.addTemplateChildControl( "c126", c126 );
	c126.renderTemplateChildControls = function( placeholder ){
		var t_c127 = document.createTextNode( "\n\n003\n\n" );
		placeholder.appendChild( t_c127 );
	};
};
...
klass( 'TTestControl013a', TTemplateControl, {
	
	
} );


TTestControl013a.prototype.createChildControls = function(){
	var ExpressionContext = this;
	var SourceTemplateControl = this;
	var c120 = new TContent( [] );
	this.addTemplateChildControl( "c120", c120 );
	c120.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c121"].renderContentsInPlaceholder( placeholder );
	};
	var c121 = new TContent(  {
					"ID" : "ca"
					}  );
	c120.addTemplateChildControl( "c121", c121 );
	c121.renderTemplateChildControls = function( placeholder ){
		var t_c122 = document.createTextNode( "\n\n\t002\n\n\t" );
		placeholder.appendChild( t_c122 );
		this._templateControls["c123"].renderContentsInPlaceholder( placeholder );
		var t_c124 = document.createTextNode( "\n\n\t004\n\n\n" );
		placeholder.appendChild( t_c124 );
	};
	var c123 = new TTestControl013b(  {
					"ID" : "b"
					}  );
	c121.addTemplateChildControl( "c123", c123 );
};
...
TTestControl013.prototype.createChildControls = function(){
	var ExpressionContext = this;
	var SourceTemplateControl = this;
	var c115 = new TContent( [] );
	this.addTemplateChildControl( "c115", c115 );
	c115.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c116"].renderContentsInPlaceholder( placeholder );
	};
	var c116 = new TContent(  {
					"ID" : "c"
					}  );
	c115.addTemplateChildControl( "c116", c116 );
	c116.renderTemplateChildControls = function( placeholder ){
		var t_c117 = document.createTextNode( "\n\n\t001\n\n\t" );
		placeholder.appendChild( t_c117 );
		this._templateControls["c118"].renderContentsInPlaceholder( placeholder );
		var t_c119 = document.createTextNode( "\n\n\t005\n\n" );
		placeholder.appendChild( t_c119 );
	};
	var c118 = new TTestControl013a(  {
					"ID" : "a"
					}  );
	c116.addTemplateChildControl( "c118", c118 );
};
