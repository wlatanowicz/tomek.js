...
klass( 'TTestControl003b', TTemplateControl, {	
	
} );


TTestControl003b.prototype.createChildControls = function(){
	var ExpressionContext = this;
	var SourceTemplateControl = this;
	var c25 = new TContent( [] );
	this.addTemplateChildControl( "c25", c25 );
	c25.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c26"].renderContentsInPlaceholder( placeholder );
	};
	var c26 = new TContent( [] );
	c25.addTemplateChildControl( "c26", c26 );
	c26.renderTemplateChildControls = function( placeholder ){
		var h_c27 = document.createElement( "div" );
		h_c27.setAttribute( "id", "inner_div" );
		var t_c28 = document.createTextNode( "ok" );
		h_c27.appendChild( t_c28 );
		placeholder.appendChild( h_c27 );
	};
};
...
klass( 'TTestControl003a', TTemplateControl, {	
	
} );


TTestControl003a.prototype.createChildControls = function(){
	var ExpressionContext = this;
	var SourceTemplateControl = this;
	var c21 = new TContent( [] );
	this.addTemplateChildControl( "c21", c21 );
	c21.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c22"].renderContentsInPlaceholder( placeholder );
	};
	var c22 = new TContent( [] );
	c21.addTemplateChildControl( "c22", c22 );
	c22.renderTemplateChildControls = function( placeholder ){
		var h_c23 = document.createElement( "div" );
		h_c23.setAttribute( "id", "outer_div" );
		this._templateControls["c24"].renderContentsInPlaceholder( h_c23 );
		placeholder.appendChild( h_c23 );
	};
	var c24 = new TTestControl003b( [] );
	c22.addTemplateChildControl( "c24", c24 );
};
