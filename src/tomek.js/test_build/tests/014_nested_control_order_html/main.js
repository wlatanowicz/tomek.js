...
TTestControl014b.prototype.createChildControls = function(){
	var ExpressionContext = this;
	var SourceTemplateControl = this;
	var c141 = new TContent( [] );
	this.addTemplateChildControl( "c141", c141 );
	c141.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c142"].renderContentsInPlaceholder( placeholder );
	};
	var c142 = new TContent(  {
					"ID" : "cb"
					}  );
	c141.addTemplateChildControl( "c142", c142 );
	c142.renderTemplateChildControls = function( placeholder ){
		var t_c143 = document.createTextNode( "\n\n\t003\n\n" );
		placeholder.appendChild( t_c143 );
	};
};
...
klass( 'TTestControl014a', TTemplateControl, {
	
	
} );


TTestControl014a.prototype.createChildControls = function(){
	var ExpressionContext = this;
	var SourceTemplateControl = this;
	var c134 = new TContent( [] );
	this.addTemplateChildControl( "c134", c134 );
	c134.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c135"].renderContentsInPlaceholder( placeholder );
	};
	var c135 = new TContent(  {
					"ID" : "ca"
					}  );
	c134.addTemplateChildControl( "c135", c135 );
	c135.renderTemplateChildControls = function( placeholder ){
		var h_c136 = document.createElement( "div" );
		var t_c137 = document.createTextNode( "\n\t\t002\n\t" );
		h_c136.appendChild( t_c137 );
		placeholder.appendChild( h_c136 );
		this._templateControls["c138"].renderContentsInPlaceholder( placeholder );
		var h_c139 = document.createElement( "div" );
		var t_c140 = document.createTextNode( "\n\t\t004\n\t" );
		h_c139.appendChild( t_c140 );
		placeholder.appendChild( h_c139 );
	};
	var c138 = new TTestControl014b(  {
					"ID" : "b"
					}  );
	c135.addTemplateChildControl( "c138", c138 );
};




klass( 'TTestControl014', TTemplateControl, {
	
	
} );


TTestControl014.prototype.createChildControls = function(){
	var ExpressionContext = this;
	var SourceTemplateControl = this;
	var c128 = new TContent( [] );
	this.addTemplateChildControl( "c128", c128 );
	c128.renderTemplateChildControls = function( placeholder ){
		this._templateControls["c129"].renderContentsInPlaceholder( placeholder );
	};
	var c129 = new TContent(  {
					"ID" : "c"
					}  );
	c128.addTemplateChildControl( "c129", c129 );
	c129.renderTemplateChildControls = function( placeholder ){
		var t_c130 = document.createTextNode( "\n\n\t001\n\n\t" );
		placeholder.appendChild( t_c130 );
		var h_c131 = document.createElement( "div" );
		this._templateControls["c132"].renderContentsInPlaceholder( h_c131 );
		placeholder.appendChild( h_c131 );
		var t_c133 = document.createTextNode( "\n\n\t005\n\n" );
		placeholder.appendChild( t_c133 );
	};
	var c132 = new TTestControl014a(  {
					"ID" : "a"
					}  );
	c129.addTemplateChildControl( "c132", c132 );
};
