...
import TDraggable from "@framework/WebControls/DragDrop/TDraggable";
 ...
 * 
 **/
export default class TDroppable extends TWebControl implements TEventResponderInterface
{
    ...
    {
        if (this._event === null) {
            this._event = new TEventResponder(this, ['DragOver','DragLeave','DragEnter','Drop']);
        }
        return this._event;
    }
