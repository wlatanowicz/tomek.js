import TTouchView from "@framework/WebControls/Mobile/TTouchView";
import TEventResponderInterface from "@framework/TEventResponderInterface";
import TContent from "@framework/TPlaceHolder";
import TStencil from "@framework/TStencil";
import TTouchScrollViewEventResponder from "@framework/WebControls/Mobile/TTouchScrollViewEventResponder";
 ...
 *
 **/
export default class TTouchScrollView extends TTouchView implements TEventResponderInterface
{
    _refreshBoxHeight = 0;
    _refreshBox = null;
    _headerHeight = 44;
    _RefreshPuller: TStencil = null;
    _boundTouchEnd = null;
    ...
    {
        if (this._event === null) {
            this._event = new TTouchScrollViewEventResponder(this, ['Scroll', 'Refresh']);
        }
        return this._event;
    }
